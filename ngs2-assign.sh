...
for sample in S1 S2;do
  ...
  gatk --java-options "-Xmx2G" BaseRecalibrator -R ../ref/chr22_with_ERCC92.fa -I ../GATK_results/picard_res/${sample}_dedupped.bam --known-sites ../ref/chr22.vcf -O ../GATK_results/gatk_res/${sample}.report


  gatk --java-options "-Xmx2G" ApplyBQSR -R ../ref/chr22_with_ERCC92.fa -I ../GATK_results/picard_res/${sample}_dedupped.bam -bqsr ../GATK_results/gatk_res/${sample}.report -O ../GATK_results/gatk_res/${sample}.bqsr.bam --add-output-sam-program-record --emit-original-quals
done
